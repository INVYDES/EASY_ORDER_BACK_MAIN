        ...
        try {
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'other_sales'         => $v['otros'],
                    'propinas_efectivo'   => $v['propinas_efectivo'],
                    'propinas_tarjeta'    => $v['propinas_tarjeta'],
                    'propinas_transferencia' => $v['propinas_transferencia'],
                    'propinas_paypal'     => $v['propinas_paypal'],
                    'propinas_mercadopago' => $v['propinas_mercadopago'],
                    'total_propinas'      => ($v['propinas_efectivo'] + $v['propinas_tarjeta'] + $v['propinas_transferencia'] + $v['propinas_paypal'] + $v['propinas_mercadopago']),
