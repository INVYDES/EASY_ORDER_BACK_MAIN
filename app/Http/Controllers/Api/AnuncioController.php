...
class AnuncioController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $anuncios = Anuncio::with(['producto:id,nombre,precio,precio_mediano,precio_grande,imagen', 'paquete:id,nombre,precio,imagen'])
    ...
    public function vigentes(Request $request)
    {
        try {
            ...
            $query = Anuncio::with(['producto:id,nombre,precio,precio_mediano,precio_grande,imagen', 'paquete:id,nombre,precio,imagen'])
                ->where('restaurante_id', $restaurante->id)
                ->vigentes();
